...
public class G2Hard extends AppCompatActivity {
    private final int SPEECH_RECOGNITION_CODE = 1;
    private TextView tv1, tv2, tv3, tv4, tv5;
    private ImageButton mic1, mic2, mic3, mic4, mic5;
    Button nextbtn;

    String ans1 = "Never let a stumble in the road be the end of the journey";
    String ans2 = "library";
    String ans3 = "beach";
    String ans4 = "laptop";
    //List<String> ans4= Arrays.asList("TV", "telivision");
    String ans5 = "hope is only thing stronger";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g2_hard);
