...
public class G2Medium extends AppCompatActivity {
    private final int SPEECH_RECOGNITION_CODE = 1;
    private TextView tv1, tv2, tv3, tv4, tv5;
    private ImageButton mic1, mic2, mic3, mic4, mic5;
    Button nextbtn;

    String ans1 = "difficult roads always lead to beautiful destination";
    String ans2 = "honesty is the best quality";
    String ans3 = "never underestimate ability of our own";
    String ans4 = "the best way to get things done is to simply begin";
    String ans5 = "dreams donnot become real unless you work hard on it";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g2_medium);
